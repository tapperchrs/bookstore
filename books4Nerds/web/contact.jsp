<%-- 
    Document   : contact
    Created on : Oct 28, 2019, 1:31:34 PM
    Author     : 01792538
--%>
    ...
    <body>
        ...
        <div class="contact">
            <div class="container">
                ...
                <br>
                <p class="col-md-4">Address: 188 Richards Ave, Norwalk, CT</p>
                <p class="col-md-4">Phone Number: 203-555-4221</p>
                <p class="col-md-4">Email: support@books4nerds.com</p>
            </div>
        </div>
